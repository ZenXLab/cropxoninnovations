...
const platforms: Platform[] = [
  ...
  },
  {
    ...
    description: 'Public engineering knowledge and learning platform focused on production-grade software engineering — playbooks, learning paths, and AI-assisted education.',
    icon: GraduationCap,
    color: 'hsl(145, 55%, 45%)',
    status: 'live',
    category: 'Education',
    useCases: ['Engineering Playbooks', 'Learning Paths', 'AI Learning', 'Platform Engineering'],
    keyFeatures: ['Production Focus', 'Hands-On Labs', 'Mentorship', 'CropXon Backed'],
    targetAudience: ['Engineers', 'Professionals', 'Teams', 'Partners'],
    route: '/stackcraft',
  },
  {
    id: 'originx-labs',
