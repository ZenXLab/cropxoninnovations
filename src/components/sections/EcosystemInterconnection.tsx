...
const platforms = [
  ...
  { id: 'stackcraft', name: 'StackCraft', icon: GraduationCap, color: 'hsl(145, 55%, 45%)', angle: 150 },
...
const dataFlows = [
  ...
  { from: 'zenith-core', to: 'stackcraft', label: 'Content' },
  { from: 'stackcraft', to: 'huminex', label: 'Learning Paths' },
