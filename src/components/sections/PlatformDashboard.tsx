...
const platformsData: PlatformData[] = [
  ...
  },
  {
    id: 'stackcraft',
    name: 'StackCraft',
    domain: 'stackcraft.io',
    icon: GraduationCap,
    color: 'hsl(145, 55%, 45%)',
    tagline: 'Engineering Knowledge Platform',
    description: 'Production-grade engineering knowledge platform with playbooks, learning paths, and AI-assisted education.',
    whoFor: ['Engineers', 'Developers', 'Tech Teams', 'Enterprises'],
    metrics: [
      { label: 'Active Engineers', value: '24.8K', trend: 'up', change: '+1,240' },
      { label: 'Playbooks', value: '287', trend: 'up', change: '+18' },
      { label: 'Certifications', value: '8,420', trend: 'up', change: '+524' },
      { label: 'Skill Mastery', value: '94.2%', trend: 'up', change: '+2.1%' },
    ],
    capabilities: [
