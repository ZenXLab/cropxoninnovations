...
const products: Product[] = [
  ...
  },
  {
    ...
    description: "Advanced robotics and autonomous systems division for next-generation automation.",
  ...
  },
  {
    ...
    description: "A new platform in stealth development, addressing critical gaps in enterprise infrastructure.",
